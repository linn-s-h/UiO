...
class Oblig5Del2B{
    ...
    public static void yeet(String[] args) throws InterruptedException { 
        //Koden din her
        ...
        try {
            ...
            monitor.settAntFlettinger(monitor.antHashMap() - 1); //Sender antall flettinger som skal gjøres, for å unngå deadlock
